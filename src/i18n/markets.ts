...
export const MARKETS_STRINGS: Record<Locale, any> = {
  en: {
    ...
    fxHeading: 'Foreign Exchange — 40+ Pairs',
    commoditiesHeading: 'Commodities',
    cryptoHeading: 'Crypto — Top 10',
    indicesHeading: 'Global Equity Indices',
  ...
  fa: {
    ...
    fxHeading: 'ارزها — بیش از ۴۰ جفت',
    commoditiesHeading: 'کالاها',
    cryptoHeading: 'رمزارز — ۱۰ مورد برتر',
    indicesHeading: 'شاخص‌های سهام جهانی',
    newsHeading: 'آخرین اخبار',
  ...
  de: {
    ...
    fxHeading: 'Devisen — 40+ Paare',
    commoditiesHeading: 'Rohstoffe',
    cryptoHeading: 'Krypto — Top 10',
    indicesHeading: 'Globale Aktienindizes',
    newsHeading: 'Aktuelle Nachrichten',
  ...
  sr: {
    ...
    fxHeading: 'Devize — 40+ parova',
    commoditiesHeading: 'Robe',
    cryptoHeading: 'Kripto — Top 10',
    indicesHeading: 'Globalni berzanski indeksi',
    newsHeading: 'Najnovije vesti',
