...
## What counts as a digital service under EU VAT rules?

{/* AEO Answer Capsule */}
EU VAT law defines digital services narrowly — telecommunications, broadcasting, and electronically supplied services delivered with minimal human intervention. Software downloads, SaaS subscriptions, hosted courses without a live instructor, e-books, and template packs are in scope; consulting delivered over a video call, custom project work, live workshops, and coaching are not. Selling your own time keeps you out of the regime entirely; selling a recorded version of that same material puts you in it.
{/* End AEO Capsule */}
...
## What does the €10,000 EU VAT OSS threshold actually cover?

{/* AEO Answer Capsule */}
Since July 2021 there's a single EU-wide threshold of €10,000 per calendar year, cumulative across all member states combined, not per country. Below it, you can keep charging your home country's VAT rate on cross-border B2C digital sales and skip OSS. Above it, destination-country rates apply from the transaction that crosses the line, and you stay bound by those rules for the rest of that year and the following one, even if sales fall back.
{/* End AEO Capsule */}
...
## Which OSS scheme should you register under?

{/* AEO Answer Capsule */}
There are three schemes: the Union scheme, for EU-established businesses selling intra-EU B2C services, registered in your own member state; the Non-Union scheme, for businesses with no EU establishment selling to EU consumers, registered in any chosen member state; and the Import scheme (IOSS), for imported goods under €150, which doesn't apply to digital services. Registration takes about twenty minutes and takes effect from the first day of the following quarter.
{/* End AEO Capsule */}
...
## What evidence do you need to charge the right VAT rate?

{/* AEO Answer Capsule */}
The law requires two pieces of non-contradictory evidence of the customer's location — billing address, IP geolocation, card issuer country, or SIM country code — though sellers under €100,000 in annual cross-border digital sales can rely on just one. Payment processors like Stripe and Paddle already capture this at checkout; Paddle and Lemon Squeezy go further as merchant of record, taking on the VAT obligation entirely for a higher processing fee around 5%.
{/* End AEO Capsule */}
...
## What does the quarterly OSS return actually involve?

{/* AEO Answer Capsule */}
OSS returns are due by the end of the month following each quarter — 30 April, 31 July, 31 October, 31 January — with no shift for weekends. For each member state you sold into, you report the taxable amount and VAT due by rate, in one payment your identification state distributes. Nil returns are still required if you sold nothing that quarter, and records must be kept for ten years, longer than most billing platforms retain data by default.
{/* End AEO Capsule */}
